...
<template>
  ...
  <footer class="dark:bg-gray-800 border-t" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div>
              ...
              <ul role="list" class="mt-4 space-y-4">
                <li v-for="item in navigation.solutions" :key="item.name">
                  <a :href="item.href" class="text-base text-gray-800 hover:text-white dark:text-gray-300">{{ item.name }}</a>
                </li>
              </ul>
            </div>
        ...
        <div class="mt-8 xl:mt-0">
          ...
          <p class="mt-4 text-base text-gray-800 dark:text-gray-300">The latest news, articles, and resources, sent to your inbox weekly.</p>
